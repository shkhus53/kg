{{--
    Identical to Laravel's default 'pagination::tailwind' view, minus the
    built-in "Showing X to Y of Z results" paragraph — used on pages (like
    the Khidmatguzar Directory) that already render their own count/summary
    line, so the two never appear together.
--}}
